...
export const HoverSlider = React.forwardRef(function HoverSlider(
...
export const TextStaggerHover = React.forwardRef(function TextStaggerHover(
...
export const HoverSliderImageWrap = React.forwardRef(function HoverSliderImageWrap(
  { className, ...props },
  ref
) {
  return (
...
export const HoverSliderImage = React.forwardRef(function HoverSliderImage(
  { index, imageUrl, className, ...props },
  ref
) {
