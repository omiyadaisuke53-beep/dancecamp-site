...
export const RESERVATION_URL = "https://your-booking-link.example.com";
...
export const FAQ = {
  ...
  items: [
    ...
    },
    {
      ...
      a: {
        en: "Full refund up to 30 days before, 50% up to 14 days before. From 2 days before to the day of, 100% is charged.",
        ja: "開催30日前まで全額返金、14日前まで50%返金。2日前〜当日は100%。",
      },
    },
  ],
};
...
export const FOOTER = {
  ...
  rights: {
    en: "Dance Camp is a fictional concept site.",
    ja: "Dance Camp はコンセプト用のサンプルサイトです。",
  },
  links: [
    {
